...
public class MultiViewTypeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Context mContext;
    int total_types;
    ArrayList<HomeRecyclerContentCard> slider_image_list;
    int page = 0;
        ...
        if (object != null) {
            switch (object.type) {
                case Data.VIEW_PAGER:
                    ...
                    slider_image_list = new ArrayList<HomeRecyclerContentCard>();

                    //Add few items to slider_image_list ,this should contain url of images which should be displayed in slider
                    // here i am adding few sample image links, you can add your own
                    HomeRecyclerContentCard card_1 = new HomeRecyclerContentCard("drawable://"+R.drawable.card_1,"baloons");
                    HomeRecyclerContentCard card_2 = new HomeRecyclerContentCard("drawable://"+R.drawable.card_2,"plants");
                    HomeRecyclerContentCard card_3 = new HomeRecyclerContentCard("drawable://"+R.drawable.card_3,"sky");
                    HomeRecyclerContentCard card_4 = new HomeRecyclerContentCard("drawable://"+R.drawable.card_4,"gelly");

                    slider_image_list.add(card_1);
                    slider_image_list.add(card_2);
                    slider_image_list.add(card_3);
                    slider_image_list.add(card_4);
