...
public class GirlFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        product1.setThumbnail(R.drawable.girl_1);
        product1.setPrice("399");

        Product product2 = new Product();
        product2.setName("Batman");
        product2.setThumbnail(R.drawable.girl_2);
        product2.setPrice("399");

        Product product3 = new Product();
        product3.setName("Deadpool");
        product3.setThumbnail(R.drawable.girl_3);
        product3.setPrice("399");

        Product product4 = new Product();
        product4.setName("Orange");
        product4.setThumbnail(R.drawable.girl_4);
        product4.setPrice("399");

        Product product5 = new Product();
        product5.setName("Triangle");
        product5.setThumbnail(R.drawable.girl_5);
        product5.setPrice("399");

        Product product6 = new Product();
        product6.setName("Me");
        product6.setThumbnail(R.drawable.girl_6);
        product6.setPrice("399");

        Product product7 = new Product();
        product7.setName("We");
        product7.setThumbnail(R.drawable.girl_7);
        product7.setPrice("399");

        Product product8 = new Product();
        product8.setName("Figgit");
        product8.setThumbnail(R.drawable.girl_8);
